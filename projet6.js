...
let p1x= Math.floor(Math.random() * 1500);
let p1y= Math.floor(Math.random() * 600);

let img3x= Math.floor(Math.random() * 1990);
let img3y= Math.floor(Math.random() * 600);

let img4x= Math.floor(Math.random() * 1990);
let img4y= Math.floor(Math.random() * 600);

let img5x= Math.floor(Math.random() * 1990);
let img5y= Math.floor(Math.random() * 600);
